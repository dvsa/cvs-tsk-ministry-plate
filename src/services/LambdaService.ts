...
class LambdaService {
     ...
     */
    public validateInvocationResponse(response: Lambda.Types.InvocationResponse): any {
        ...
        if (payload.statusCode >= 400) {
            throw new HTTPError(500, `Lambda invocation returned error: ${payload.statusCode} ${payload.body}`);
        }
